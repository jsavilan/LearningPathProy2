...
public class PanelExamen extends JPanel{
	...
	public PanelExamen(Examen exam) {
		...
		int tamanio = exam.getPreguntasAbiertas().size();
		
		while (contador < tamanio) {
			
			int numPreg = contador +1;
			
			pregunta = new JLabel(numPreg + ". " + exam.getPreguntasAbiertas().get(contador));
